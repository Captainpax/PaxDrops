...
If the player wanted to order, the player must message Mr Stacks to order another drop. I would like it limited to one drop a day at the base tier and then max tier up to three extra orders. 
